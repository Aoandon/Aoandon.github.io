...
$(".about .blast").each(function() {
  ...
  if (a == 400) {
    setTimeout(function() {
      $(".about h1 img").addClass("animated rotateIn");
    }, 500);
  }
...
setTimeout(function() {
  $(".about .flat-button").addClass("animated bounceIn");
  $(
    ".about .flat-button"
  ).one(
    "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
    function() {
      $(".about .flat-button").removeClass("animated bounceIn");
      $(".about .flat-button").css("opacity", 1);
    }
  );
}, 2000);

$(".about .flat-button").mouseenter(function() {
  var el = $(this);
