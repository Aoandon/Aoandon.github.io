...
$(".contact .blast").each(function() {
  ...
  if (a == 400) {
    setTimeout(function() {
      $(".contact h1 img").addClass("animated rotateIn");
    }, 500);
  }
...
setTimeout(function() {
  $(".contact .flat-button").addClass("animated bounceIn");
  $(
    ".contact .flat-button"
  ).one(
    "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
    function() {
      $(".contact .flat-button").removeClass("animated bounceIn");
      $(".contact .flat-button").css("opacity", 1);
    }
  );
}, 2000);

$(".contact .flat-button").mouseenter(function() {
  var el = $(this);
