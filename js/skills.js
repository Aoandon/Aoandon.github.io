...
$(".skills .blast").each(function() {
  ...
  if (a == 400) {
    setTimeout(function() {
      $(".skills h1 img").addClass("animated rotateIn");
    }, 500);
  }
...
setTimeout(function() {
  $(".skills .flat-button").addClass("animated bounceIn");
  $(
    ".skills .flat-button"
  ).one(
    "webkitAnimationEnd mozAnimationEnd MSAnimationEnd oanimationend animationend",
    function() {
      $(".skills .flat-button").removeClass("animated bounceIn");
      $(".skills .flat-button").css("opacity", 1);
    }
  );
}, 2000);

$(".skills .flat-button").mouseenter(function() {
  var el = $(this);
